  ...
  return (
    <section className="mx-auto w-full max-w-2xl space-y-8 print:space-y-6 mb-8">
      ...
      <div className="prose prose-neutral dark:prose-invert text-neutral-200">
        <p className="text-lg">Someday, I want to work at my dream company</p>
        ...
        <p className="text-lg">Someday, I want to live abroad</p>
        <p className="-mt-2 text-neutral-300">
        ...
        <p className="text-lg">Someday, I want to speak a tech conference</p>
        <p className="-mt-2 text-neutral-300">
        ...
        <p className="text-lg">Someday, I want to learn to fly</p>
        <p className="-mt-2 text-neutral-300">
        ...
        <p className="text-lg">Someday, I want to work because I want to</p>
        <p className="-mt-2 text-neutral-300">
