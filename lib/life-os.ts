...
// The store gains at most a handful of rows per day per metric, so an hour of staleness
// is invisible on the page but keeps the API off the hot path of every request.
