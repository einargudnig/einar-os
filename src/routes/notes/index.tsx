...
export const Route = createFileRoute("/notes/")({
  head: () => ({
    meta: [
      { title: "Notes — Einar Gudni" },
      { name: "description", content: "Quick thoughts and ideas" },
      { property: "og:title", content: "Notes" },
      { property: "og:description", content: "Quick thoughts and ideas" },
